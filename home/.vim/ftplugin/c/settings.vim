...
" COMPILER
	nnoremap <Leader><CR> :!make 2>makeErr<CR>:tabnew<CR>:tabmove<CR>:e makeErr<CR>

" UTILITY
	nnoremap <Leader>F;		A;<Esc>
	nnoremap <Leader>fso	asizeof<Space><Space>(<Space><Space>)<Esc>
...
" Specifiers
	nnoremap <Leader>ta	^iauto<Space><Esc>
	nnoremap <Leader>tr	^iregister<Space><Esc>
	nnoremap <Leader>ts	^istatic<Space><Esc>
	nnoremap <Leader>te	^iextern<Space><Esc>
	nnoremap <leader>tC	^iconst<space><Esc>
	nnoremap <Leader>tV	^ivolatile<Space><Esc>
	nnoremap <Leader>tR	^irestrict<Space><Esc>
" Typedef
...
" Usually used functions
	nnoremap <Leader>fpf	oprintf<Space>("",)<Left><Left><Left>
	nnoremap <Leader>fsf	oscanf<Space>("%", &)<Left>
	nnoremap <Leader>fps	oputs<Space>("");<Esc>2hi
	nnoremap <Leader>fpS	aputs<Space>("");<Esc>2hi
	nnoremap <Leader>fgs	ogets<Space>();<Left><Left>
	nnoremap <Leader>fgc	o<Space>=<Space>getc<Space>(<Space><Space>);<Esc>I
	nnoremap <Leader>fgC	a<Space>=<Space>getc<Space>(<Space><Space>);<Esc>
